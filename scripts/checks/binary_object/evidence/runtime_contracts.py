...
STAGE3B_ORDERED_CONTRACTS = (('stage3b-validated-construction',
 ...
 ('stage3b-proxy-call-order',
  ...
  ('let data = runtime .proxy_snapshot_if_any(&proxy)?',
   ...
   'Ok(ProxyCallStep::Read { object: rooted.handler.clone(), key: self.key.clone(), receiver: Value::Object(rooted.handler.clone()),',
 ...
 ('stage3b-proxy-call-order',
  ...
  ('let Phase::Method { rooted, mut search } = self.phase else',
   ...
   'runtime.direct_call_target_from_value(Value::Object(rooted.target.clone()))?, search.receiver, search.arguments,',
   ...
   'method, Value::Object(rooted.handler.clone()), vec![ Value::Object(rooted.target.clone()), search.receiver, Value::Object(array), ],',

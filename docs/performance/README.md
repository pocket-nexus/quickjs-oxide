...
> 当前工作（2026-09-26）：测量与文档修正、八项 V8 的函数／PC 诊断、单次融合入口选择及普通写入分类内联已实现，固定矩阵与执行契约已复核。原版 V8 时间采样按维护者要求在 RegExp 后停止；候选正式 Score 和时间准入仍未裁决。本轮身份、逐片回退及已测／未测范围统一见[当前收据](receipts/entry-choice-2026-09-26/README.md)。

...
No benchmark function was run. `am3`, `lin_solve`, `advect`, and `project` each
occurred exactly once. The generated dump, manifest, and build log are retained
outside this PR; this page keeps the verified coverage summary.

The 25 published flags are R0: 5, R1: 4, R2: 1, R3: 12, R4: 1, W0: 1,
...
R0 flag at PC 44. The 23 `GetArrayEl`-anchored R0 triad audit found 5 accepted
R0, 1 site claimed by a longer candidate at the same
...
published spans are counted separately above.

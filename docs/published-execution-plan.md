...
状态：计划范围内的实现与候选处置已完成；验证与独立评审记录以 PR #18 为准。基于 PR #17 的 `b11f2be`，见 [PR #18](https://github.com/pocket-stack/quickjs-oxide/pull/18) 和[执行契约说明](published-execution-contracts.md)。

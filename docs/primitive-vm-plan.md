...
状态：2026-09-14，已确定继续使用**栈虚拟机**。S01–S07 已验收；S07 完整测量显示固定 58 项耗时为 PR19 的 1.17–5.28 倍，67 个成本样本零旧分派、零桥接。S08–S10 尚未实施；[回退分析](performance/README.md)与[两阶段优化方案](primitive-vm-commit-plan.md#4-优化与最终交付)已更新，具体证据以逐 commit 计划和迁移清单为准。
